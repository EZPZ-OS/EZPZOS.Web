	...
	return (
		<div className="h-28 mb-2 rounded-lg flex items-center" onClick={() => handleDishDetail(dishDetail.Id)}>
			...
			<div className="flex-1 flex-row ml-2">
				...
				<span className="h-[15px] text-sm rounded-md bg-gradient-to-r from-[#a72353b3] to-[#DC4200] opacity-90 px-2 py-1 text-white">
					{dishDetail.Category}
				</span>
				{/* {
				...
				<div className="leading-none mt-1 mb-1 text-gray-500 mr-3 text-ellipsis overflow-hidden line-clamp-2">
