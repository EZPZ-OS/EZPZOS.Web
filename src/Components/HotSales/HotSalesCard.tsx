 ...
 * @returns
 */
export default function HotSalesCard(props: {
	rank: number;
	dishName: string;
	like_pc: number;
	like_qty: number;
	...
	return (
		<div className="w-[146px] h-[205px] bg-white rounded-[7px] relative ml-[5px]">
			<div className="w-[48px] h-[21px] bg-[#fbe6bb] rounded-tl-[7px] rounded-br-[7px] flex justify-center items-center absolute">
				<span className="text-[14px]/[21px] ">
					{DefaultHotSaleValues.DefaultTag}
					{props.rank}
				</span>
			</div>
			<div className="ml-[5px]">
				<div className="w-[135px] h-[110px]   pt-[5px] text-[#4D4D4D] text-[14px] leading-[21px]">
					...
					<div className=" font-normal">
						<LuThumbsUp className=" inline-block" />
						<span className="ml-[5px]">
							{props.like_pc}%({props.like_qty})
						</span>
					</div>
					<div className="">${props.price}</div>
					<div className="absolute right-[5px] bottom-[5px] w-[30px] h-[30px] bg-gradient-to-t from-[#cd4e23] to-[#f29d50] rounded-full flex justify-center items-center">
