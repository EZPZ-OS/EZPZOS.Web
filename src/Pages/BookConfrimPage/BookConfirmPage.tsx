			...
			<div className="absolute top-16 left-5 w-[calc(100vw_-_40px)] m-auto bg-white rounded-lg">
				<section className="ml-4 mr-4 mt-3 mb-3">
					...
					<div className="flex flex-row mt-3 items-center">
						<GoPerson />
						<span className="text-[#FB6300] ml-2">
							{BookConfirmInfo.PeopleNum} {DefaultBookConfirmationValues.PeopleText}
						</span>
					</div>
				...
				<section className="ml-4 mr-4 mt-3">
					...
					<div className="flex flex-row bg-[#D7D7D7] rounded-md">
						<span className="w-16 h-8 leading-8 text-center bg-[#C0C0C0] text-[#422626] rounded-md">
							{DefaultBookConfirmationValues.CodeText}
						</span>
						<input
							className="h-8 bg-[#D7D7D7] px-2 outline-transparent"
							placeholder={DefaultBookConfirmationValues.PhonePlaceHolder}
				...
				<section className="ml-4 mr-4 mt-3 flex flex-column justify-between">
					<div className="flex flex-col">
						...
						<input
							className="h-8 bg-[#D7D7D7] outline-transparent rounded-md"
				...
				<section className="ml-4 mr-4 mt-3">
					<div className="flex flex-col">
						...
						<textarea
							className="h-8 bg-[#D7D7D7] outline-transparent rounded-md px-1"
				...
				<section className="ml-4 mr-4 mt-5 flex flex-row justify-between items-center">
					...
					<Switch
						onChange={handleReceiveOfferChange}
						checked={receiveOfferVal}
						uncheckedIcon={false}
						checkedIcon={false}
						width={45}
						height={19}
				...
				<section
					className="w-[288px] h-10 leading-10 text-white text-center bg-orange-gradient m-auto mt-4 mb-4 rounded-xl"
					onClick={handleContinue}
				>
					{DefaultBookConfirmationValues.BtnText}
				</section>
			</div>
		</div>
	);
